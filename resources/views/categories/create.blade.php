    ...
    <div class="page-content">
        ...
        <div class="content">
            <ul class="breadcrumb">
                ...
                <li>
                    {{ @trans('labels.nav_main_cats') }}
                </li>
                <li><a href="#" class="active">Create</a></li>
            </ul>
            <div class="page-title"><i class="icon-custom-left"></i>
                <h3>{{ @trans('labels.create') }} - <span class="semi-bold">{{ @trans('labels.category') }}</span></h3>
            </div>
                        ...
                        <div class="grid-body no-border">
                            ...
                            <div class="row">
                                <form class="" role="form" enctype="multipart/form-data"
                                      method="POST" action="{{ action('CategoryController@postStore') }}">
                                    {!! csrf_field() !!}
