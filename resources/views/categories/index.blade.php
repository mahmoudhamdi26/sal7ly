    ...
    <div class="page-content">
        ...
        <div class="content">
            ...
            <div class="page-title"><i class="icon-custom-left"></i>
                ...
                <a class="nav-link text-muted" href="{{ action('CategoryController@getCreate') }}"
                ...
                <div class="col-md-12">
                    <div class="grid simple ">
                        ...
                        <div class="grid-body no-border">
                            <h3>
                                <span class="semi-bold">{{ @trans('labels.table') .' '.  @trans('labels.categories') }}</span>
                            </h3>
                            <table class="table no-more-tables">
                                ...
                                @foreach($items as $item)
                                    <tr>
                                        ...
                                        <td class="v-align-middle">
                                            <div class="btn-group">
                                                <a href="{{ action('CategoryController@getEdit', $item->id ) }}"
                                                   class="btn" aria-pressed="false"><i class="fa fa-edit"></i></a>
                                                <a onclick="return confirm('Are you sure you want to delete this item?');"
                                                   href="{{ action('CategoryController@getDestroy', $item->id ) }}"
